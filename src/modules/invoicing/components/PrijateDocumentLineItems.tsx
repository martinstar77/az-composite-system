...
import type { PrijatyDokladFormValues } from '../types/formSchema'
import { vypocitejRadek, vypocitejSoucty, formatMena } from '../utils/calculations'
import { DPH_SAZBY } from '../types'

interface PrijateDocumentLineItemsProps {
  products: Product[]
  isBill: boolean
}

export function PrijateDocumentLineItems({ products, isBill }: PrijateDocumentLineItemsProps) {
  const { control, register, setValue, watch } = useFormContext<PrijatyDokladFormValues>()
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-zinc-900/15 p-4 rounded-xl border border-zinc-800/60 shadow-inner">
          ...
          <div className="flex flex-col justify-end space-y-2 text-sm pr-2">
            ...
            <div className="flex justify-between items-center text-base font-bold">
              <span className="text-zinc-300">Celková částka:</span>
