-- Migration: Update logistics validation function to use safe density lower bounds for chemicals
-- Prevents false physical paradox errors on solvent-based products.
